...
### Answer 1: Longtitude kommer først og latitude kommer som nummer to. Deres forkortelse er "lng" og "lat".
...
# Solution - Already used in Task One. 
...
# Vi har benyttet Co-Pilot for hjælp, og brugt hintet som en prompt. 
...
# Your brief answer:
# Uden cluster får vi et bredt overblik af Danmark og de individuelle spots omkring. 
# Med cluster får vi et mere overskueligt overblik hvor vi kan se hvor koncentreret nogle steder er.
